...
echo "Sector count for $BOOT1_BINARY_LOCATION = $BOOT1_BINARY_FINAL_SIZE sector(s)."
...
echo "Sector count for $KERNEL_BINARY_LOCATION = $KERNEL_BINARY_FINAL_SIZE sector(s)."
