...
int vga_get_offset(int vga_column, int vga_row) { return 2 * (vga_row * VGA_MAX_COLS + vga_column); }
int vga_get_offset_row(int vga_offset) { return vga_offset / (2 * VGA_MAX_COLS); }
int vga_get_offset_col(int vga_offset) { return (vga_offset - (vga_get_offset_row(vga_offset) * 2 * VGA_MAX_COLS)) / 2; }
