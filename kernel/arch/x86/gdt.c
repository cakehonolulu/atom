...
int i386_gdt_install()
{
    ...
    // Opcode: 32-bit
    i386_gdt_add_entry(1, 0, 0xFFFFFFFF, I386_GDT_CODE_RING0_ACCESS, I386_GDT_FLAGS);

    /* GDT Data Segment */
    // Segment Type: Data
    // Rest is same as Code Segment
    i386_gdt_add_entry(2, 0, 0xFFFFFFFF, I386_GDT_DATA_RING0_ACCESS, I386_GDT_FLAGS);

    /* GDT Code Segment */
    // Segment Type: Code
    i386_gdt_add_entry(3, 0, 0xFFFFFFFF, I386_GDT_CODE_RING3_ACCESS, I386_GDT_FLAGS);

    /* GDT Code Segment */
    // Segment Type: Code
    i386_gdt_add_entry(4, 0, 0xFFFFFFFF, I386_GDT_DATA_RING3_ACCESS, I386_GDT_FLAGS);
